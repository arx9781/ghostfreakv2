...
const navItems = {
  ...
  "/spotify": { name: "Spotify", icon: LucideDisc3 },
  "/blog": { name: "Blog", icon: LucideRss },
  "/guestbook": { name: "Guestbook", icon: LucideNotebookText },
};
  ...
  return (
    <>
      ...
      <div className="fixed left-0 bottom-0 w-full z-[100] md:hidden">
        ...
        <nav className="flex relative justify-between w-full z-[100] py-2">
